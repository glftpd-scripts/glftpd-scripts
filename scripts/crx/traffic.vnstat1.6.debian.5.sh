...
#####
#
# works with debian 5.0.8 @ Kernel 2.6.26-2-amd64
# uses vnstat 1.6, which doesnt output the Average.
#
#
#
#
...
estimatednumber=$(${vnstat_bin} -m | grep estimated | awk '{ print $8}')
   ...
   if [ "$traffic_limit" = "TRUE" ]; then
      ...
      echo -e "\002\003\064[\002\003TRAFFIC\002\003\064]\002\003 for $thismonth - RX:\002 ${incoming} \002- TX:\002 ${outgoing} \002- TOTAL:\002 ${total} [${maxpercent1}%] \002 -  ESTIMATED:\002 ${estimated} [${maxpercent2}%] \002"
   else
      echo -e "\002\003\064[\002\003TRAFFIC\002\003\064]\002\003 for $thismonth - RX:\002 ${incoming} \002- TX:\002 ${outgoing} \002- TOTAL:\002 ${total} \002 - ESTIMATED:\002 ${estimated} \002"
   fi
fi
...
echo -e "\002\003\064[\002\003TRAFFIC\002\003\064]\002\003 for $thisday - RX:\002 ${incoming} \002- TX:\002 ${outgoing} \002- TOTAL:\002 ${total} \002 - ESTIMATED:\002 ${estimated}\002"
fi
...
estimatednumber=$(${vnstat_bin} -w | grep estimated | awk '{ print $8}')
   if [ "$traffic_limit" = "TRUE" ]; then
      ...
      echo -e "\002\003\064[\002\003TRAFFIC\002\003\064]\002\003 for week $thiswk of $thisyr - RX:\002 ${incoming} \002- TX:\002 ${outgoing} \002- TOTAL:\002 ${total} [${maxpercent1}%] \002 - ESTIMATED:\002 ${estimated} [${maxpercent2}%] \002"
   else 
      echo -e "\002\003\064[\002\003TRAFFIC\002\003\064]\002\003 for week $thiswk of $thisyr - RX:\002 ${incoming} \002- TX:\002 ${outgoing} \002- TOTAL:\002 ${total} \002 - ESTIMATED:\002 ${estimated} \002"
   fi
fi
