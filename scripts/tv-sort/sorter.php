...
# German
$REGEX['RET-DE-HD']	=	"/(?P<title>.+)\.((?P<season>S\d{1,2})?)E(?P<episode>\d{1,3}).+[Gg][Ee][Rr][Mm][Aa][Nn]\.(UNCUT\.)?(([DdAaFf][LlCcTtSs][3Ss]{0,1}\.){0,4}?)[17][02][80][0]{0,1}[pP]\.[Bb][Ll][Uu][Rr][Aa][Yy](\.[Ff][Ii][Xx])?(\.[Rr][Ee][Pp][Aa][Cc][Kk])?(\.[Rr][Ee][Aa][Dd]\.[Nn][Ff][Oo])?(\.[Ii][Nn][Tt][Ee][Rr][Nn][Aa][Ll])?\.([Rr][Ee][Aa][Dd][Nn][Ff][Oo]\.)?[Xx]264(\.[Rr][Ee][Pp][Aa][Cc][Kk])?\-.+/";
...
$REGEX['RET-DE-SD']	=	"/(?P<title>.+)\.((?P<season>S\d{1,2})?)E(?P<episode>\d{1,3}).+[Gg][Ee][Rr][Mm][Aa][Nn]\.(UNCUT\.)?([0-9]{4}\.)?([Aa][Nn][Ii][Mm][Ee]\.)?(([WwFfDd][SsLl]\.){0,2}?)([Rr][Ee][Pp][Aa][Cc][Kk]\.)?[BbDd][DdVv][Dd]?[Rr][Ii][Pp]\.([Rr][Ee][Aa][Dd]\.[Nn][Ff][Oo]\.)?([Pp][Rr][Oo][Pp][Ee][Rr](\.|\-))?([Rr][Ee][Pp][Aa][Cc][Kk]\.)?([Rr][Ee][Aa][Dd][Nn][Ff][Oo]\.)?[Xx][Vv2][Ii6][Dd4](\.[Ii][Nn][Tt][Ee][Rr][Nn][Aa][Ll])?(\.[Rr][Ee][RrPp][IiAa][PpCc][Kk]?)?(\.[Pp][Rr][Oo][Pp][Ee][Rr])?\-.+/";
$REGEX['DE-SD'] 	=	"/(?P<title>.+)\.((?P<season>S\d{1,2})?)E(?P<episode>\d{1,3}).+[Gg][Ee][Rr][Mm][Aa][Nn].+\.([Rr][Ee][Aa][Dd][Nn][Ff][Oo]\.)?[Xx][Vv2][Ii6][Dd4](\.[Rr][Ee][Pp][Aa][Cc][Kk])?(\.[Rr][Ee][Pp][Aa][Cc][Kk])?(\.[Rr][Ee][Aa][Dd]\.[Nn][Ff][Oo])?\-.+/";
# English
